...
public class SearchOptionPanel extends JPanel{
	...
	JPanel createAdditionalPPOptions() {
		...
		c.right().expandHoriz().insets(0,10,0,5);
		iidEvid = new JCheckBox("All IID evidence", false);
		iidEvid.setToolTipText("Select if you want to include all IID evidence types (experimentally detected, orthologous, computationally predicted). Default is experimental!");
