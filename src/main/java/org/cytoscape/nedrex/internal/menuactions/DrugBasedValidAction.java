...
import org.cytoscape.nedrex.internal.tasks.DrugBasedValidTask;
...
public class DrugBasedValidAction extends AbstractCyAction {
    ...
    public DrugBasedValidAction(RepoApplication app, RepoResultPanel resultPanel) {
        ...
        this.infoBox = new InfoBox(app, message, this.nedrexService.TUTORIAL_LINK + "availableFunctions.html#drug-centric-method");
